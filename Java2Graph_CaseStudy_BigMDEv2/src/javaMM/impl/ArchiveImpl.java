 ...
 * <ul>
 *   <li>{@link javaMM.impl.ArchiveImpl#getOriginalFilePath <em>Original File Path</em>}</li>
 *   <li>{@link javaMM.impl.ArchiveImpl#getClassFiles <em>Class Files</em>}</li>
 *   <li>{@link javaMM.impl.ArchiveImpl#getManifest <em>Manifest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArchiveImpl extends NamedElementImpl implements Archive {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.ARCHIVE;
	}
	...
	public void setOriginalFilePath(String newOriginalFilePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.ARCHIVE__ORIGINAL_FILE_PATH, oldOriginalFilePath, originalFilePath));
	}
	...
	public EList<ClassFile> getClassFiles() {
		if (classFiles == null) {
			classFiles = new EObjectContainmentEList<ClassFile>(ClassFile.class, this, JavaMMPackage.ARCHIVE__CLASS_FILES);
		}
		return classFiles;
	}
	...
	public NotificationChain basicSetManifest(Manifest newManifest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaMMPackage.ARCHIVE__MANIFEST, oldManifest, newManifest);
	...
	public void setManifest(Manifest newManifest) {
		if (newManifest != manifest) {
			...
			if (manifest != null)
				msgs = ((InternalEObject)manifest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaMMPackage.ARCHIVE__MANIFEST, null, msgs);
			if (newManifest != null)
				msgs = ((InternalEObject)newManifest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaMMPackage.ARCHIVE__MANIFEST, null, msgs);
			msgs = basicSetManifest(newManifest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.ARCHIVE__MANIFEST, newManifest, newManifest));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaMMPackage.ARCHIVE__CLASS_FILES:
				return ((InternalEList<?>)getClassFiles()).basicRemove(otherEnd, msgs);
			case JavaMMPackage.ARCHIVE__MANIFEST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaMMPackage.ARCHIVE__ORIGINAL_FILE_PATH:
