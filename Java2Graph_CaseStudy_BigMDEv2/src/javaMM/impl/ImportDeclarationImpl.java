 ...
 * <ul>
 *   <li>{@link javaMM.impl.ImportDeclarationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link javaMM.impl.ImportDeclarationImpl#getImportedElement <em>Imported Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportDeclarationImpl extends ASTNodeImpl implements ImportDeclaration {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.IMPORT_DECLARATION;
	}
	...
	public void setStatic(boolean newStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.IMPORT_DECLARATION__STATIC, oldStatic, static_));
	}
	...
	public NamedElement getImportedElement() {
		if (importedElement != null && importedElement.eIsProxy()) {
			...
			if (importedElement != oldImportedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaMMPackage.IMPORT_DECLARATION__IMPORTED_ELEMENT, oldImportedElement, importedElement));
			}
		}
	...
	public NotificationChain basicSetImportedElement(NamedElement newImportedElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaMMPackage.IMPORT_DECLARATION__IMPORTED_ELEMENT, oldImportedElement, newImportedElement);
	...
	public void setImportedElement(NamedElement newImportedElement) {
		if (newImportedElement != importedElement) {
			...
			if (importedElement != null)
				msgs = ((InternalEObject)importedElement).eInverseRemove(this, JavaMMPackage.NAMED_ELEMENT__USAGES_IN_IMPORTS, NamedElement.class, msgs);
			if (newImportedElement != null)
				msgs = ((InternalEObject)newImportedElement).eInverseAdd(this, JavaMMPackage.NAMED_ELEMENT__USAGES_IN_IMPORTS, NamedElement.class, msgs);
			msgs = basicSetImportedElement(newImportedElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.IMPORT_DECLARATION__IMPORTED_ELEMENT, newImportedElement, newImportedElement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaMMPackage.IMPORT_DECLARATION__IMPORTED_ELEMENT:
				if (importedElement != null)
					msgs = ((InternalEObject)importedElement).eInverseRemove(this, JavaMMPackage.NAMED_ELEMENT__USAGES_IN_IMPORTS, NamedElement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaMMPackage.IMPORT_DECLARATION__STATIC:
				return isStatic();
			case JavaMMPackage.IMPORT_DECLARATION__IMPORTED_ELEMENT:
