 ...
 * <ul>
 *   <li>{@link ICMTAuthor.impl.ConferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConferenceImpl extends MinimalEObjectImpl.Container implements Conference {
	...
	protected EClass eStaticClass() {
		return ICMTAuthorPackage.Literals.CONFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ICMTAuthorPackage.CONFERENCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ICMTAuthorPackage.CONFERENCE__NAME:
				return getName();
		}
