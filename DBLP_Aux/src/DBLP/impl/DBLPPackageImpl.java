...
public class DBLPPackageImpl extends EPackageImpl implements DBLPPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getRecord_Authors(), this.getAuthor(), this.getAuthor_Records(), "authors", null, 1, -1, Record.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
