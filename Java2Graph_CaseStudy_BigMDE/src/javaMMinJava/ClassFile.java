...
public class ClassFile extends NamedElement implements Serializable,
		IdentifiableElement {
	...
	public ClassFile(String id, String name, Boolean proxy,
			...
			AbstractTypeDeclaration type, CompilationUnit attachedSource,
			Package package_) {
