		...
		public  class Package  extends NamedElement implements Serializable, IdentifiableElement {
			...
			AbstractTypeDeclaration ownedElements; Boolean ownedElementsIsComposed = true;
			
			Model model; Boolean modelIsComposed = false;
			
			Package ownedPackages; Boolean ownedPackagesIsComposed = true;
			
			Package package_; Boolean packageIsComposed = false;
			
			PackageAccess usagesInPackageAccess; Boolean usagesInPackageAccessIsComposed = false;
			...
			public Package(
				...
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				ImportDeclaration usagesInImports,				AbstractTypeDeclaration ownedElements,				Model model,				Package ownedPackages,				Package package_,				PackageAccess usagesInPackageAccess ){
