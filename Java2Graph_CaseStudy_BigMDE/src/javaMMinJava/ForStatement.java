...
public class ForStatement extends Statement implements Serializable,
		IdentifiableElement {
	...
	public ForStatement(String id,

	Comment[] comments, CompilationUnit originalCompilationUnit,
			ClassFile originalClassFile, Expression expression,
			Expression[] updaters, Expression[] initializers, Statement body) {
