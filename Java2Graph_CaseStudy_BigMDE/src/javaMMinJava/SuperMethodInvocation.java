...
public class SuperMethodInvocation extends AbstractTypeQualifiedExpression
	...
	public SuperMethodInvocation(String id,

	Comment[] comments, CompilationUnit originalCompilationUnit,
			ClassFile originalClassFile, TypeAccess qualifier,
			AbstractMethodDeclaration method, Expression[] arguments,
			TypeAccess[] typeArguments) {

		super(comments, originalCompilationUnit, originalClassFile, qualifier);
