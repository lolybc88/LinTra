		...
		public  class CompilationUnit  extends NamedElement implements Serializable, IdentifiableElement {
			...
			public CompilationUnit(
				...
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				ImportDeclaration usagesInImports,				Comment commentList,				ImportDeclaration imports,				Package package_,				AbstractTypeDeclaration types ){
