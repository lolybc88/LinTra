		...
		public abstract class AbstractMethodInvocation  extends ASTNode implements Serializable, IdentifiableElement {
			...
			Expression arguments; Boolean argumentsIsComposed = true;
			
			TypeAccess typeArguments; Boolean typeArgumentsIsComposed = true;
