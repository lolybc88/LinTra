		...
		public  class Package  extends NamedElement implements Serializable, IdentifiableElement {
			...
			public Package(
				...
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				ImportDeclaration usagesInImports,				AbstractTypeDeclaration ownedElements,				Model model,				Package ownedPackages,				Package package,				PackageAccess usagesInPackageAccess ){
