		...
		public  class Annotation  extends Expression implements Serializable, IdentifiableElement {
			...
			AnnotationMemberValuePair values; Boolean valuesIsComposed = true;
			...
			public Annotation(
				String id,				
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				TypeAccess type,				AnnotationMemberValuePair values ){
