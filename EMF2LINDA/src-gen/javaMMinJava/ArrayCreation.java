		...
		public  class ArrayCreation  extends Expression implements Serializable, IdentifiableElement {
			...
			Expression dimensions; Boolean dimensionsIsComposed = true;
			
			ArrayInitializer initializer; Boolean initializerIsComposed = true;
			...
			public ArrayCreation(
				String id,				
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				Expression dimensions,				ArrayInitializer initializer,				TypeAccess type ){
