		...
		public  class AnonymousClassDeclaration  extends ASTNode implements Serializable, IdentifiableElement {
			...
			ClassInstanceCreation classInstanceCreation; Boolean classInstanceCreationIsComposed = false;
			...
			public AnonymousClassDeclaration(
				String id,				
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				BodyDeclaration bodyDeclarations,				ClassInstanceCreation classInstanceCreation ){
