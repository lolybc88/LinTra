		...
		public  class CatchClause  extends Statement implements Serializable, IdentifiableElement {
			...
			SingleVariableDeclaration exception; Boolean exceptionIsComposed = true;
			...
			public CatchClause(
				String id,				
				,
				Comment comments,				CompilationUnit originalCompilationUnit,				ClassFile originalClassFile,				SingleVariableDeclaration exception,				Block body ){
