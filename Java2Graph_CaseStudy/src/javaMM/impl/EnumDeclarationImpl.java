 ...
 * <ul>
 *   <li>{@link javaMM.impl.EnumDeclarationImpl#getEnumConstants <em>Enum Constants</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumDeclarationImpl extends AbstractTypeDeclarationImpl implements EnumDeclaration {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.ENUM_DECLARATION;
	}
	...
	public EList<EnumConstantDeclaration> getEnumConstants() {
		if (enumConstants == null) {
			enumConstants = new EObjectContainmentEList<EnumConstantDeclaration>(EnumConstantDeclaration.class, this, JavaMMPackage.ENUM_DECLARATION__ENUM_CONSTANTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaMMPackage.ENUM_DECLARATION__ENUM_CONSTANTS:
