 ...
 * <ul>
 *   <li>{@link javaMM.impl.AbstractMethodInvocationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link javaMM.impl.AbstractMethodInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link javaMM.impl.AbstractMethodInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractMethodInvocationImpl extends ASTNodeImpl implements AbstractMethodInvocation {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION;
	}
		...
		if (method != null && method.eIsProxy()) {
			...
			if (method != oldMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaMMPackage.ABSTRACT_METHOD_INVOCATION__METHOD, oldMethod, method));
			}
		}
		return method;
	}
	...
	public NotificationChain basicSetMethod(AbstractMethodDeclaration newMethod, NotificationChain msgs) {
		...
		method = newMethod;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaMMPackage.ABSTRACT_METHOD_INVOCATION__METHOD, oldMethod, newMethod);
	...
	public void setMethod(AbstractMethodDeclaration newMethod) {
		if (newMethod != method) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.ABSTRACT_METHOD_INVOCATION__METHOD, newMethod, newMethod));
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, JavaMMPackage.ABSTRACT_METHOD_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public EList<TypeAccess> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, JavaMMPackage.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaMMPackage.ABSTRACT_METHOD_INVOCATION__METHOD:
				if (method != null)
					msgs = ((InternalEObject)method).eInverseRemove(this, JavaMMPackage.ABSTRACT_METHOD_DECLARATION__USAGES, AbstractMethodDeclaration.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case JavaMMPackage.ABSTRACT_METHOD_INVOCATION__ARGUMENTS:
				return ((InternalEList<?>)getArguments()).basicRemove(otherEnd, msgs);
			case JavaMMPackage.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS:
