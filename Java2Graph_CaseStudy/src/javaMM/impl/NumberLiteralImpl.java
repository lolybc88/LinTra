 ...
 * <ul>
 *   <li>{@link javaMM.impl.NumberLiteralImpl#getTokenValue <em>Token Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumberLiteralImpl extends ExpressionImpl implements NumberLiteral {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.NUMBER_LITERAL;
	}
	...
	public void setTokenValue(String newTokenValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.NUMBER_LITERAL__TOKEN_VALUE, oldTokenValue, tokenValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaMMPackage.NUMBER_LITERAL__TOKEN_VALUE:
