...
public class TransfoRunnerEMFTVM {
	...
	public double runTransformation(String uriInMM, Object inMMPackageImpl, String inMMName,
			String uriOutMM, Object outMMPackageImpl, String outMMName,
		...
		rs.getPackageRegistry().put(uriOutMM, outMMPackageImpl);
		...
		mm2.setResource(rs.getResource(URI.createURI(uriOutMM), true));
		env.registerMetaModel(outMMName, mm2);
...
//		// Load models
		...
		outModel.setResource(rs.createResource(URI.createFileURI(outModelP)));
