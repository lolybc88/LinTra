 ...
 * <ul>
 *   <li>{@link javaMM.impl.JavadocImpl#getTags <em>Tags</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavadocImpl extends CommentImpl implements Javadoc {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.JAVADOC;
	}
	...
	public EList<TagElement> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList<TagElement>(TagElement.class, this, JavaMMPackage.JAVADOC__TAGS);
		}
		return tags;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaMMPackage.JAVADOC__TAGS:
