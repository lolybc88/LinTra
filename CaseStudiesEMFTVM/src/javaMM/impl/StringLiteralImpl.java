 ...
 * <ul>
 *   <li>{@link javaMM.impl.StringLiteralImpl#getEscapedValue <em>Escaped Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return JavaMMPackage.Literals.STRING_LITERAL;
	}
	...
	public void setEscapedValue(String newEscapedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMMPackage.STRING_LITERAL__ESCAPED_VALUE, oldEscapedValue, escapedValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaMMPackage.STRING_LITERAL__ESCAPED_VALUE:
