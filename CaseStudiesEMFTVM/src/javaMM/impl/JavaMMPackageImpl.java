 ...
 * @generated
 */
public class JavaMMPackageImpl extends EPackageImpl implements JavaMMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see javaMM.JavaMMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private JavaMMPackageImpl() {
		super(eNS_URI, JavaMMFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link JavaMMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static JavaMMPackage init() {
		if (isInited) return (JavaMMPackage)EPackage.Registry.INSTANCE.getEPackage(JavaMMPackage.eNS_URI);

		// Obtain or create and register package
		JavaMMPackageImpl theJavaMMPackage = (JavaMMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JavaMMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new JavaMMPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theJavaMMPackage.createPackageContents();

		// Initialize created meta-data
		theJavaMMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theJavaMMPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(JavaMMPackage.eNS_URI, theJavaMMPackage);
		return theJavaMMPackage;
	}
	 ...
	 * @generated
	 */
	public JavaMMFactory getJavaMMFactory() {
		return (JavaMMFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, javaMM.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_OwnedElements(), this.getAbstractTypeDeclaration(), this.getAbstractTypeDeclaration_Package(), "ownedElements", null, 0, -1, javaMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Model(), this.getModel(), this.getModel_OwnedElements(), "model", null, 0, 1, javaMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_OwnedPackages(), this.getPackage(), this.getPackage_Package(), "ownedPackages", null, 0, -1, javaMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Package(), this.getPackage(), this.getPackage_OwnedPackages(), "package", null, 0, 1, javaMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_UsagesInPackageAccess(), this.getPackageAccess(), this.getPackageAccess_Package(), "usagesInPackageAccess", null, 0, -1, javaMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
