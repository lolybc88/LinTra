...
public class Public2Private_OutPlace implements ITransformation {

	IArea srcArea, trgArea;

	public Public2Private_OutPlace(IArea srcArea, IArea trgArea)
	...
	private void transf(List<IdentifiableElement> elems, IdentifiableElement ie) throws BlackboardException {
		...
		if (ie instanceof javaMMinJava.Modifier) {
			...
			if (((javaMMinJava.Modifier) ie).getBodyDeclaration()!=null){
				BodyDeclaration bd = (BodyDeclaration) srcArea.read(((javaMMinJava.Modifier) ie).getBodyDeclaration());
				if (bd!=null && bd instanceof FieldDeclaration && ((javaMMinJava.Modifier) ie).getVisibility().equals("public")){
					((javaMMinJava.Modifier) oe).setVisibility("private");
				}
			}
		...
		if (ie instanceof javaMMinJava.FieldDeclaration) {
			String trgId = TraceFunction.create(ie.getId(), 1, "FieldDeclaration");
			...
			javaMMinJava.FieldDeclaration oe = new javaMMinJava.FieldDeclaration(
					...
					TraceFunction.resolve(((javaMMinJava.FieldDeclaration) ie)
							.getAnonymousClassDeclarationOwner(),
							"anonymousClassDeclarationOwner"),
					TraceFunction.resolve(((javaMMinJava.FieldDeclaration) ie).getModifier(), "modifier"),
							TraceFunction.resolve(
			...
			if (mId!=null){
				...
				if (mod!=null){
					...
					if (visibility.equals("public")){
						...
						// the visibility is modified in the rule that transforms the modifiers
						// the transfo is much complex
						...
						for (String fragmentId : fragmentsIds){
							...
							singleVarAccess.setTrgId(TraceFunction.create(ie.getId(), 3, "FieldDeclaration"));
							...
							returnS.setTrgId(TraceFunction.create(ie.getId(), 4, "FieldDeclaration"));
							
							TypeAccess ta = new TypeAccess("", null, null, null, ((javaMMinJava.FieldDeclaration) ie).getTypeID(), null);
							ta.setTrgId(TraceFunction.create(ie.getId(), 5, "FieldDeclaration"));
							...
							block.setTrgId(TraceFunction.create(ie.getId(), 6, "FieldDeclaration"));
							
							String getterMethTrgId = TraceFunction.create(ie.getId(), 7, "FieldDeclaration"); 
							String getterModTrgId = TraceFunction.create(ie.getId(), 8, "FieldDeclaration");
							...
							elems.add(getterMod); elems.add(singleVarAccess); elems.add(returnS); elems.add(ta); elems.add(block); elems.add(getterMeth);
							
							// Create the setter
							SingleVariableAccess singleVarAccess2 = new SingleVariableAccess("", null, null, null, fragmentId, null);
							singleVarAccess2.setTrgId(TraceFunction.create(ie.getId(), 9, "FieldDeclaration"));
							
							ThisExpression thisExpr = new ThisExpression("", null, ((javaMMinJava.FieldDeclaration) ie).getOriginalCompilationUnit(), null, null);
							thisExpr.setTrgId(TraceFunction.create(ie.getId(), 10, "FieldDeclaration"));
							...
							fieldAccess.setTrgId(TraceFunction.create(ie.getId(), 11, "FieldDeclaration"));
							//
							
							SingleVariableAccess singleVarAccess3 = new SingleVariableAccess("", null, null, null, fragmentId, null);
							singleVarAccess3.setTrgId(TraceFunction.create(ie.getId(), 12, "FieldDeclaration"));
							...
							assign.setTrgId(TraceFunction.create(ie.getId(), 13, "FieldDeclaration"));
							// 
							...
							exprStat.setTrgId(TraceFunction.create(ie.getId(), 14, "FieldDeclaration"));
							...
							block2.setTrgId(TraceFunction.create(ie.getId(), 15, "FieldDeclaration"));
							
							String setterMethTrgId = TraceFunction.create(ie.getId(), 16, "FieldDeclaration");
							String setterModTrgId = TraceFunction.create(ie.getId(), 17, "FieldDeclaration"); 
							...
							elems.add(singleVarAccess2); elems.add(thisExpr); elems.add(fieldAccess); elems.add(singleVarAccess3); elems.add(assign);
							elems.add(exprStat); elems.add(block2); elems.add(setterMod); elems.add(setterMeth); 
