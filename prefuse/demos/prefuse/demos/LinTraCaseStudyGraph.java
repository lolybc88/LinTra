 ...
 */
public class LinTraCaseStudyGraph extends JPanel {
    ...
    public LinTraCaseStudyGraph(Graph g, String label) {
...
//        setGraph(g, label);
        ...
        Graph graphG = null;
        try {
//            graph = new GraphMLReader().readGraph("/socialnet2.xml");
        	graphG = new GraphMLReader().readGraph("C:/Users/Loli/Desktop/javaDependencies.xml");
     ...
     // draw the "name" label for NodeItems
        ...
        // COLOR: red for Abstract, blue for final and green for normal
        int[] colorPalette = new int[] {
            ColorLib.rgb(255,96,96), ColorLib.rgb(100,200,255), ColorLib.rgb(153,255,0)
        };
        DataColorAction fill = new DataColorAction("graph.nodes", "type",
                Constants.NOMINAL, VisualItem.FILLCOLOR, colorPalette);
        ...
        // SHAPE
//        int[] shapesPalette = new int[]
//                { Constants.SHAPE_RECTANGLE, Constants.SHAPE_DIAMOND, Constants.SHAPE_STAR };
//        DataShapeAction shape = new DataShapeAction("graph.nodes", "type", shapesPalette);
        
        // SIZE
        DataSizeAction size = new DataSizeAction("graph.nodes", "size", 100);
...
//        opanel.add(overview);
    ...
    public static void main(String[] args) {
        ...
        // create graphview
//        String datafile = "graphml-sample.xml";
//        String label = "color";
        
        String datafile = "C:/Users/Loli/Desktop/javaDependencies.xml";
        String label = "name";
    ...
    public static JFrame demo(Graph g, String label) {
        final LinTraCaseStudyGraph view = new LinTraCaseStudyGraph(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private LinTraCaseStudyGraph m_view;
        public GraphMenuAction(String name, String accel, LinTraCaseStudyGraph view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(LinTraCaseStudyGraph view) {
            m_view = view;
